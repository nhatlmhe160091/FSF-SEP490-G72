          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Môn thể thao</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Mô tả ngắn</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tùy chọn</th>
              </tr>
            </thead>
