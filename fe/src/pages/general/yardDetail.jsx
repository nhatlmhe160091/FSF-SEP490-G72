            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            {
                                name: "Soccer Field B2",
                                image: "https://images.unsplash.com/photo-1459865264687-595d652de67e?ixlib=rb-4.0.3",
                                price: 45,
                                rating: 4.5
                            },
                            {
                                name: "Soccer Field C3",
                                image: "https://images.unsplash.com/photo-1516132006923-6cf348e5dee2?ixlib=rb-4.0.3",
                                price: 55,
                                rating: 4.8
                            },
                            {
                                name: "Soccer Field D1",
                                image: "https://images.unsplash.com/photo-1518604666860-9ed391f76460?ixlib=rb-4.0.3",
                                price: 48,
                                rating: 4.2
                            }
                        ].map((field, index) => (
                            <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-green-600 font-bold">${field.price}/hr</span>
