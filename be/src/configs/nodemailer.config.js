...
async function sendVerificationEmail(email, verificationLink) {
    const mailOptions = {
        from: emailApp,
        to: email,
        subject: "Xác minh tài khoản ứng dụng datsan.io.vn",
        text: `datsan.io.vn xin chào bạn!\n\nBạn vui lòng vào liên kết sau để xác thực tài khoản: ${verificationLink}\n\nCảm ơn bạn!`,
        html: `
            <div style="font-family: Arial, sans-serif; padding: 20px;">
                <h2 style="color: #333;">Chào bạn!</h2>
                <p>Cảm ơn bạn đã đăng ký tài khoản trên ứng dụng <strong>datsan.io.vn</strong>. Để hoàn tất quá trình đăng ký, bạn vui lòng nhấn vào liên kết dưới đây để xác thực tài khoản của mình:</p>
                ...
                <p>Cảm ơn bạn!</p>
                <p>Đội ngũ hỗ trợ của datsan.io.vn</p>
            </div>
        `
    };
...
async function sendNewPassword(email, newPassword) {
    const mailOptions = {
        from: emailApp,
        to: email,
        subject: "Cấp lại mật khẩu tài khoản trên ứng dụng datsan.io.vn",
        text: `datsan.io.vn xin chào bạn!\n\nMật khẩu mới của bạn là: ${newPassword}\n\nXin hãy đăng nhập vào tài khoản của bạn để thay đổi mật khẩu nếu cần.\n\nCảm ơn bạn!`,
        html: `
            <div style="font-family: Arial, sans-serif; padding: 20px;">
                <h2 style="color: #333;">Chào bạn!</h2>
                <p>Mật khẩu mới của bạn cho tài khoản <strong>datsan.io.vn</strong> là:</p>
